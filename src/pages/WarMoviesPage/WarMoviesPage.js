...
import * as warMoviesService from "../../services/warMoviesService";
...
const WarMoviesPage = () => {
  ...
  const handleNextPage = () => {
    const fetchApi = async () => {
      const result = await warMoviesService.getWarMovies(nextPage);
      return setWarMovies(result.results);
    };
    fetchApi();
    ...
    <div className="mt-16 text-white lg:max-w-[90rem] mx-auto px-2 lg:px-4">
      ...
      <div className="mb-3">
        <div className="p-5 bg-[#303b42] text-[15px] leading-[22px]">
          ...
          tục. Tải hơn 10.000 bộ phim chiến tranh năm{" "}
